"""Regenerate only archive/index.html using existing manifest and entry JSONs."""
...
def main() -> None:
    ...
    print("Regenerating archive/index.html ...")
    start = time.perf_counter()
    generate_index_html(import_dir, archive_root, entries_dir, manifest_path)
    end = time.perf_counter()
    print(f"Done. Wrote {archive_root / 'index.html'} in {end - start:.2f}s.")
